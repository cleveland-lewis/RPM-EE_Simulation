...
def test_infer_from_simulations_empty():
    ...
    predicted, info = system._infer_from_simulations([])
...
def test_evaluate_predictions_logs_history_and_updates_truth():
    ...
    # New entries also log attunement and blend diagnostics
    assert {"truth", "predicted", "score"}.issubset(entry.keys())
